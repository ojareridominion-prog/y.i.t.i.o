# Only changed the bot responses, kept everything else the same
# ===================================================
# FILE: main.py
# Y.I.T BOT MAIN FILE
# ===================================================
...
# Initialize FastAPI
app = FastAPI(title="Y.I.T Bot API")
...
async def cmd_start(message: Message):
    ...
    await message.answer(
        "🎬 *Y.I.T - Your Infinite Video Stream*\n\n"
        "Watch endless YouTube Shorts all in one place!\n"
    ...
    try:
        ...
        if not user_result.data or len(user_result.data) == 0:
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                ...
                [InlineKeyboardButton(text="🎬 Open Y.I.T", web_app={"url": "https://ojareridominion-prog.github.io/y.i.t.i.o/"})]
            ])
            await message.answer(
                "✨ *Y.I.T Premium*\n\n"
...
async def startup_event():
    """Run startup tasks"""
    logger.info("🚀 Starting Y.I.T Bot...")
